...
@click.option('--infected_states', default="I_n,I_a,I_s,E,J_n,J_s", help="Comma separated list of infected states.")
def run(plot_files, label_names, out_file, fit_me, show_whole_fit, title, column, zip_to_feather, figsize, ymax, xlabel,
        ylabel, use_median, use_sd, day_indices, day_labels, nodes_counts, infected_states):
