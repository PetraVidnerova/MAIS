...
model_definition = {
    ...
    "model_parameters": {
        ...
        "beta_reduction": (0,  "beta reduction"),
        "beta_in_family": (0, "beta in family"),
        "beta_A": (0, "beta A"),
        "beta_A_in_family": (0, "beta A in family"),
        ...
        "delta_n": (0, "probability of entering Jn"),
        "delta_s": (0, "probability of entering Js")
    }
}
...
def calc_propensities(model, use_dict=True):
    ...
    numI = model.current_state_count(
        STATES.I_s) + model.current_state_count(STATES.I_ds)
    ...
    propensity_I_n_to_I_dn = model.memberships[STATES.I_n] * \
        model.theta_In * model.psi_In
    ...
    # state I_a
    propensity_I_a_to_I_da = model.memberships[STATES.I_a] * \
        model.theta_Ia * model.psi_Ia
    propensity_I_a_to_I_s = model.memberships[STATES.I_a] * \
    ...
    # state I_s
    propensity_I_s_to_I_ds = model.memberships[STATES.I_s] * \
        model.testable * model.theta_Is * model.psi_Is
